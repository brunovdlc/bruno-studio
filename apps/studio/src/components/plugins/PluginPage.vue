    ...
    <div class="header">
      ...
      <div class="alert alert-danger" v-if="!plugin.loadable && plugin.installed">
        ...
        <div class="alert-body expand">
          <span>This plugin requires version {{ plugin.minAppVersion }} or newer. Please upgrade your Bruno Studio or <a href="https://docs.beekeeperstudio.io/user_guide/plugins/#installing-a-specific-plugin-version">install</a> a compatible plugin version.</span>
        </div>
      </div>
